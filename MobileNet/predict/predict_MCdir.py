...
def main():
    ...
    # 读取类的名称映射
    json_path = "D:/计算机视觉学习/deep-learning-for-image-processing-master/data_set/cuttings/cuttings_classes.json"
    ...
    model_weight_path = "D:/计算机视觉学习/deep-learning-for-image-processing-master/data_set/model/cuttings_MobileNetV3.pth"
